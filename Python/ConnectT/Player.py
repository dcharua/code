...
class Player(object):
    ...
    def make_three(self,board,turn,row,column):
        try:
            return board[row+1][column] == turn and board[row+2][column] == turn and board[row][column+1] == 0 
            or (board[row+1][column] == turn and board[row+1][column+1] == turn)
            or (board[row+1][column] == turn and board[row+1][column-1] == turn)
            or(board[row+2][column] == turn and board[row+1][column+1] == turn)
            or (board[row+2][column] == turn and board[row+1][column-1] == turn)
            or (board[row+1][column+1] == turn and board[row][column+1] == turn)
            or(board[row+1][column+1] == turn and board[row][column+2] == turn)
            or (board[row][column+1] == turn and board[row][column+2] == turn)
            or (board[row][column+1] == turn and board[row-1][column+1] == turn)
            or(board[row][column+2] == turn and board[row-2][column+1] == turn)
            or (board[row-1][column+1] == turn and board[row-1][column] == turn)
            or (board[row-1][column+1] == turn and board[row-2][column] == turn)
            or(board[row-1][column] == turn and board[row-2][column] == turn)
            or (board[row-1][column] == turn and board[row-1][column-1] == turn)
            or (board[row-2][column] == turn and board[row-1][column-1] == turn)
            or(board[row-1][column-1] == turn and board[row][column-1] == turn)
            or (board[row-1][column-1] == turn and board[row][column-2] == turn)
            or (board[row][column-1] == turn and board[row][column-2] == turn)
            or(board[row][column-1] == turn and board[row+1][column-1] == turn)
            or (board[row][column-2] == turn and board[row+1][column-1] == turn)
        except IndexError:
            pass

    def make_two(self,board,turn,row,column):
        try:
            return board[row-1][column] == turn
            or board[row-1][column-1] == turn
            or board[row][column-1] == turn
            or board[row+1][column-1] == turn
            or board[row+1][column] == turn
            or board[row+1][column+1] == turn
            or board[row][column+1] == turn
            or board[row-1][column+1] == turn
        except IndexError:
